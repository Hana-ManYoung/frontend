        ...
        <div className="w-[90%] mx-auto">
          <div className="mt-4 text-2xl">
            ...
            <div className="mt-5 text-center text-lg">
              ...
              <div
                className="w-[50%] mt-4 mx-auto py-4 text-center text-2xl text-black bg-stone-100 shadow-md shadow-gray-400 rounded-2xl cursor-pointer hover:bg-stone-200 transition-all duration-300 ease-in-out"
...
function MainCard({ name, id, target }) {
  const navigate = useNavigate();
  return (
    <div
      className={
