      ...
      <div className="w-[90%] mx-auto  animate__animated animate__fadeIn">
        <div className="mt-4 text-2xl">
          <h2 className="font-bold flex items-center">
            규은님이 필요할 것 같아 준비했어요
            <img src="/smile.png" width="25px" className="ml-2" alt="" />
          </h2>
          <div className="mt-6 flex justify-evenly">
            <div className="w-[50%] text-center text-lg">
              ...
              <div
                className="w-[45%] mt-4 mx-auto py-4 text-center text-xl text-black "
            ...
            <SwiperSlide style={swiperStyle}>
              <div className="w-full h-full mx-auto rounded-xl bg-blue-50 flex justify-center items-center">
                <div className="w-[50%] px-16 font-basic">
                  ...
                  <h1 className="mt-2 text-3xl text-blue-900 font-bold">
                    오늘의 퀴즈
                  </h1>
                </div>
                <div className="w-[50%]">
                  <img src="/main/quiz.png" alt="" />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide style={swiperStyle}>
            ...
            <SwiperSlide style={swiperStyle}>
              <div className="w-full h-full mx-auto rounded-xl bg-purple-50 flex justify-center items-center">
                ...
                <div className="relative w-full h-full">
                  <img
                    src="/main/cardBack.jpg"
                    className="absolute w-48 right-12 -bottom-12 rounded-xl z-10 shadow-lg"
                    alt=""
                  />
                  <img
                    src="/main/cardBack.jpg"
