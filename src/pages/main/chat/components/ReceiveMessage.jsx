  ...
  if (type === "CMT_01")
    return (
      <div className="my-4">
        ...
        <p className="mt-4">
          <span className="p-3 rounded-xl bg-gradient-to-t from-slate-100 to-green-100">
    ...
    return (
      <div className="my-4">
        ...
        <div className="mt-1 rounded-xl bg-gradient-to-t from-slate-100 to-green-100 p-3 max-w-[35%]">
          <span className="">
            <img
    ...
    return (
      <div className="my-2 flex">
        <span className="rounded-xl bg-gradient-to-t from-slate-100 to-green-100 p-3">
          <img
