      ...
      <AccordionPanel pb={4}>
        <div className="max-h-[400px] overflow-y-auto">
          <p className="text-xs">
            ...
            발급매수에는 제한이 없습니다.
            <br />- 가족카드 부가서비스의 전월이용금액, 월별 할인횟수 및
            할인한도는 본인카드와 합산 적용됩니다.
            <br />- 가족카드 연말정산 시 가족카드 사용금액은 가족카드
            명의자[카드 앞(뒤)면에 표기된 [이름]의 신용카드 등 사용금액으로
            포함됩니다. 연간 소득금액 기준은 국세청 기준에 따릅니다.
            <br />- 본인회원이 가족회원의 카드사용 내역에 대한 알림을 받고자
            하는 경우 가족회원의 동의를 받아 본인회원이 고객센터(1800-1111)에
            별도 신청하여야 합니다. 가족카드 이용대금명세서는 본인회원이 지정한
            주소와 방법으로 본인회원에게 합산되어 발송됩니다. 다만, 가족카드
            이용대금명세서를 별도 요청하는 경우에는 본인회원, 가족회원에게 별도
            발송 가능합니다.
            <br />- 가족카드 이용으로 적립된 포인트는 본인회원의 포인트에
            합산되어 관리되며, 본인회원이 하나카드 고객센터(1800-1111) 및
            홈페이지>포인트양도에서 가족으로 등록된 회원에게만 양도 가능하며, 타
            회원에게 양도는 불가합니다.가족등록은 고객센터에서만 등록
            가능합니다.
            <br />- 이혼, 사망, 파양 등 가족관계 변동 시 본인회원 또는
            가족회원이 하나카드 고객센터(1800-1111) 및 홈페이지/모바일앱
            [카드관리-카드해지신청]에서 가족카드 정지 또는 해지 가능합니다.
            <br />- 가족회원의 가족관계 변동시 카드사에 즉시 통지해야하며
            가족관계 변동이 되었음에도 가족카드를 정지 또는 해지하지 않은 경우
            본인회원에게 의도하지 않은 카드사용 및 책임이 발생할 수 있습니다.
            <br />- 본인회원이 요청할 경우 가족회원의 동의 없이 가족카드가
            한도감액/정지/해지될 수 있습니다.
          </p>
        </div>
      </AccordionPanel>
